...
func parseFlags(version string) cliFlags {
	...
	fs.StringVar(&cli.viewsOpts.ViewershipEventsTable, "viewership-events-table", "livepeer-analytics.staging.staging_viewership_events", "BigQuery table to read viewership events from")
	fs.StringVar(&cli.viewsOpts.ViewershipSummaryTable, "viewership-summary-table", "livepeer-analytics.staging.staging_viewership_summary_by_video", "BigQuery table to read viewership summarized metrics from")
