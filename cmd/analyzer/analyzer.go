...
func parseFlags(version string) cliFlags {
	...
	fs.StringVar(&cli.usageOpts.ExplorerDayDataTable, "explorer-data-table", "livepeer-analytics.staging.explorer_day_data", "BigQuery table to read total usage metrics from")
